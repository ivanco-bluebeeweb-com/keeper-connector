"""HTTP client for Keeper Security API."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://keepersecurity.com/api/v2"

class KeeperSecurityClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-KeeperSecurity-Connector/1.0.0"
        }
