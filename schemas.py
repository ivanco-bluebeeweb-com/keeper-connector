"""Pydantic schemas for Keeper Security Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Keeper Security.")
    api_key: str = Field(description="Enterprise API Key / Access Token")
    base_url: str = Field(default="https://keepersecurity.com/api/v2", description="Keeper Security API base URL.")
...
class GetVaultItemParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    vaultitem_id: str = Field(description="Keeper Security VaultItem ID.")
